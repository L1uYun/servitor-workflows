...
- Extraction is intentional and bounded: strip reasoning wrappers, prefer fenced ```json, scan balanced object/array spans, then one trailing-comma repair. Transport may still strip protocol delimiters (e.g. Pi think wrappers).
